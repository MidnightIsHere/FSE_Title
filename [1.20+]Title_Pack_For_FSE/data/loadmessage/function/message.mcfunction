...
tellraw @a "数据包初始化已完成"
tellraw @a "数据包重启完毕"
tellraw @a "FSE Title Version:1.0.4 Loaded"
...
scoreboard objectives add AdvFSE_Server picked_up:potato "成就[这不只是一个土豆]计数"
scoreboard objectives add Miles_Road custom:walk_one_cm "成就[行万里路]计数"
